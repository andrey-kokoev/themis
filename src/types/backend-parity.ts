 ...
 */
export type BackendParityViolation =
  | ActionClassMismatchViolation
  | SelectorExplicitnessMismatchViolation
  | IntentStepMismatchViolation
  | ObservationBoundaryMismatchViolation
  | SemanticFieldLeakViolation;
...
export type BackendParityVerdict =
  | { aligned: true; violations: [] }
  | { aligned: false; violations: BackendParityViolation[] };
