...
// Input type (assumed from profile layer)
 ...
 */
export type TmuxObservationRequest =
  | CaptureSessionStateRequest
  | CaptureWindowStateRequest
  | CapturePaneOutputRequest;
