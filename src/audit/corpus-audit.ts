 ...
 */
export function checkLawbookCoverage(): LawbookCoverageAudit {
  const lawbooks = [
 ...
 */
export function checkImplementationCoverage(): ImplementationCoverageAudit {
 ...
 */
export function checkDeterminism(): DeterminismAudit {
 ...
 */
export function runCorpusAudit(): CorpusAuditResult {
 ...
 */
export function formatAuditReport(result: CorpusAuditResult): string {
  const lines: string[] = [];
 ...
 */
export function generateClosureReport(): string {
