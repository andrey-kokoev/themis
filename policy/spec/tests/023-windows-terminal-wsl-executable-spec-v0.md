---
id: w3p8nk
title: "Windows Terminal + WSL Executable Spec v0"
kind: exec
order: 23
source: regenerated-from-chat
---

# Windows Terminal + WSL Executable Spec v0
...
## Purpose
This executable spec turns the corresponding lawbook for **Windows Terminal + WSL** into a small, falsifiable interface.
