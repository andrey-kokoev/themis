...
## Object
This document defines the semantic boundary for **Runtime-to-Context Integration**.
...
## What it fixes
The lawbook fixes the semantics of **Runtime-to-Context Integration** without letting implementation convenience or UI accidents become semantic authority.
