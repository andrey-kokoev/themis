---
id: g4u9xe
title: "Windows Terminal + WSL Profile Lawbook v0"
kind: lawbook
order: 22
source: regenerated-from-chat
---

# Windows Terminal + WSL Profile Lawbook v0
...
## Object
This document defines the semantic boundary for **Windows Terminal + WSL Profile**.
...
## What it fixes
The lawbook fixes the semantics of **Windows Terminal + WSL Profile** without letting implementation convenience or UI accidents become semantic authority.
