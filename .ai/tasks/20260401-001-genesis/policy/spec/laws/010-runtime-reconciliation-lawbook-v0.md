---
id: p3x7nw
title: "Runtime Reconciliation Lawbook v0"
kind: lawbook
order: 10
source: regenerated-from-chat
---

# Runtime Reconciliation Lawbook v0
...
## Object
This document defines the semantic boundary for **Runtime Reconciliation**.
...
## What it fixes
The lawbook fixes the semantics of **Runtime Reconciliation** without letting implementation convenience or UI accidents become semantic authority.
