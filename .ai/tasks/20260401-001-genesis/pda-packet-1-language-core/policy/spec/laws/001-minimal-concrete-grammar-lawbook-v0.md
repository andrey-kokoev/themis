...
## Object
This document defines the semantic boundary for **Minimal Concrete Grammar**.
...
## What it fixes
The lawbook fixes the semantics of **Minimal Concrete Grammar** without letting implementation convenience or UI accidents become semantic authority.
