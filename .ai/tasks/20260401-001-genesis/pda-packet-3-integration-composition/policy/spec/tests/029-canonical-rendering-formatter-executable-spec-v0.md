---
id: j9q4lx
title: "Canonical Rendering / Formatter Executable Spec v0"
kind: exec
order: 29
source: regenerated-from-chat
---

# Canonical Rendering / Formatter Executable Spec v0
...
## Purpose
This executable spec turns the corresponding lawbook for **Canonical Rendering / Formatter** into a small, falsifiable interface.
