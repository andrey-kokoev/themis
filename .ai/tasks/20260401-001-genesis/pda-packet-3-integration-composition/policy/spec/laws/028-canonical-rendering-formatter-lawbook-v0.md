...
## Object
This document defines the semantic boundary for **Canonical Rendering / Formatter**.
...
## What it fixes
The lawbook fixes the semantics of **Canonical Rendering / Formatter** without letting implementation convenience or UI accidents become semantic authority.
