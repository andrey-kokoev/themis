 ...
 */
export function evaluateCompensation(state, action) {
    ...
    const targetAction = state.operatorActions.find(a => a.seq === action.compensatesSeq);
    if (!targetAction) {
        return {
            tag: "Inadmissible",
    ...
    switch (action.tag) {
        case "WithdrawConflictAcknowledgment":
            return evaluateWithdrawConflictAcknowledgment(state, action, targetAction);
 ...
 */
function evaluateWithdrawConflictAcknowledgment(state, action, targetAction) {
 ...
 */
function evaluateCancelRebindRequest(state, action, targetAction) {
 ...
 */
function evaluateRetractNote(state, action, targetAction) {
 ...
 */
export function getCompensableActions(state) {
 ...
 */
export function canCompensate(state, seq) {
    return getCompensableActions(state).some(a => a.seq === seq);
}
//# sourceMappingURL=operator-compensation.js.map