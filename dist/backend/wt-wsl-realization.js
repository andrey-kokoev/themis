 ...
 */
export function realizeWtWslBackend(profile, decision) {
    const steps = [];
    ...
    observationPlan.push({ tag: "CaptureTabState", tabBinding: profile.tabBinding });
 ...
 */
export function isDeterministic(profile, decision) {
...
//# sourceMappingURL=wt-wsl-realization.js.map