...
export type WorkspaceItem = ContextBlock | PersistenceClause | EquivalenceClause | RoleBlock | RelationBlock;
...
export type AstNode = Workspace | ContextBlock | ContextEntry | PersistenceClause | EquivalenceClause | RoleBlock | SubjectBlock | RealizerBlock | WitnessBlock | RelationBlock;
