 ...
 */
export type BackendStep = LaunchTabStep | ReuseTabStep | InvokeWslCommandStep | AttachTargetStep | TailSourceStep;
/**
 ...
 */
export type ObservationRequest = CaptureTabStateRequest | CaptureProfileRequest | CaptureDistroRequest | CaptureCommandResultRequest;
...
//# sourceMappingURL=wt-wsl-backend.d.ts.map